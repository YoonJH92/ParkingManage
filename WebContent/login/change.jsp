...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
<link href="../resources/bootstrap2.css" rel="stylesheet">
  ...
  <div class="jumbotron "  style="width: 60%"  >
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="email" name="name" class="form-control" placeholder="DB에서 가져올 이름~" >
      ...
      <div class="mb-3">
        ...
        <input type="email" name="email" class="form-control"  placeholder="DB에서 가져올 이메일~" >
        
      </div>
      
      <div class="mb-3">
        <label for="address">Tel</label>
        <input type="tel" name="tel" class="form-control"  placeholder="DB에서 가져올 전화번호~" >
        
      </div>
      
      <div class="mb-3">
        <label for="address">Password</label>
        <input type="password" name="pass" class="form-control"  placeholder="비밀번호를 입력해 주세요" required>
      ...
      justify-content: flex-end;">
        <input style="margin-right: 5px;" class="btn btn-primary btn-lg" href="changeProc.jsp" type="submit" value="수정">
