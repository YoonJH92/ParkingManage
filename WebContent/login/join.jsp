  ...
  <div class="jumbotron "  style="width: 60%"  >
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="password" name="pass2" class="form-control"  placeholder="비밀번호를 확인해 주세요" required>
      ...
      justify-content: flex-end;">
        <input style="margin-right: 5px;" class="btn btn-primary btn-lg" href="joinProc.jsp" type="submit" value="확인">
