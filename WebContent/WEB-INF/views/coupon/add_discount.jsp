<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td><select style="width: 25%; display:inline-block;" class="form-control animated--grow-in" name="time">
			...
			</select> <span id="time"><input style="width: 66%; display:inline-block;" class="form-control" type="text" name="time" numberOnly>시간</span>
			</td>
		</tr>
	</table>