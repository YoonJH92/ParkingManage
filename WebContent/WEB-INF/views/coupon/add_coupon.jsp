...
<table class="table table-bordered">
	...
	<tr>
		...
		<td>발급일로부터<select style="width: 25%; display:inline-block; margin-left: 3%;" class="form-control animated--grow-in" name="date">
			...
			</select> <span id="date"><input style="width: 45%; display:inline-block;" class="form-control" type="text" name="date" numberOnly>일</span>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><select style="width: 25%; display:inline-block;" class="form-control animated--grow-in" name="price">
				...
				<option value="직접 입력">직접 입력</option>
			</select> <span id="price"><input style="width: 70%; display:inline-block;" class="form-control" type="text" name="price" numberOnly>원</span>
		</td>
	</tr>
</table>