...
<div class="container py50">
	...
	<div style="margin-bottom: 60px;">
		...
		<div class="display-inline fr">
			<a href="#" id="grapBtn"
				class="d-none d-sm-inline-block btn btn-custom shadow-sm mb4"> <i
				class="fas fa-search fa-sm text-white-50"></i>시간별 출입차 현황 그래프
...
<script type="text/javascript">
	...
	$("#stat tbody tr").each(
			function(index) {
				labelArray.push($("#stat tbody tr:eq(" + index + ")")
						.children().eq(0).text());
